...
public class WorkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String str = String.format(getString(R.string.work));
        if (player.isMask()){
            if (player.isSex()) {
        ...
        btnClick(btn_left, FinalActivity.class);
        btnClick(btn_right, FinalActivity.class);
    }

    public void btnClick(AppCompatButton btn, Class<FinalActivity> c){
